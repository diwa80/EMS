                  ...
                  <div class="col-lg-12">
                      <section class="card">
                          ...
                          <div class="card-body">
                              ...
                              <form class="form-horizontal" action="{{route('employee_infos/store')}}" id="default" method="post" role="form" enctype="multipart/form-data">
                              {{ csrf_field() }}
                                  <fieldset title="Step1" class="step" id="default-step-0">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              <input type="text" class="form-control" name= "fname" placeholder="Full Name" value="{{ old('fname')}}">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              <input type="text" class="form-control" name= "uname" placeholder="Username" value="{{ old('uname')}}">
                                          </div>
                                      </div>
                                  ...
                                  <fieldset title="Step 2" class="step" id="default-step-1" >
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group date form_date-component">
                                                <input type="text" name="date" id="date" class="form-control" readonly="" size="16" value="{{ old('date') }}" >
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class=" col-lg-10 custom-file">
                                            <input type="file" id="image" name="profile_image" class="custom-file" value="{{ old('profile_image') }}" >
                                        </div>
                                      </div>
